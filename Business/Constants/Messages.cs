namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string WriterLastNameNotEmpty = "Soyad boş bırakılamaz";
        public static string WriterLastNameMinimumLength = "Soyad en az 2 karakterden oluşmalı";
        public static string WriterLastNameMaximumLength = "Soyad en fazla 50 karakterden oluşabilir";
        public static string WriterPasswordNotEmpty = "Şifre boş bırakılamaz";
