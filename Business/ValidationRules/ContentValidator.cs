...
namespace Business.ValidationRules
{
    public class ContentValidator : AbstractValidator<Content>
    {
        public ContentValidator()
        {
            ...
            RuleFor(x => x.ContentDate).NotEmpty().WithMessage(Messages.ContentDateNotEmpty);
            RuleFor(x => x.ContentDate).GreaterThan(DateTime.Today).WithMessage(Messages.ContentDateGreaterThan);
